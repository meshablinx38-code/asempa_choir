...
[System.IO.File]::WriteAllText("lib\features\badges\badges_screen.dart", $content, [System.Text.Encoding]::UTF8)
Write-Host "badges_screen.dart fixed!" -ForegroundColor Green
